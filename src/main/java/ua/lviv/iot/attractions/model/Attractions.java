...
public class Attractions {
	...
	public String getHeaders() {
		return "distanceLengthInMeters" + "," + "maxSpeedInKmPerHour" + "," + "maxHeightInMeters" + "," + "serialNumber"
				+ "," + "priceOfTicketInUSD" + "," + "numberOfChildrenOnAttractionSimultaniously" + ","
				+ "productionYear";
	}

	public String toCSV() {
		return getDistanceLengthInMeters() + "," + getMaxSpeedInKmPerHour() + "," + getMaxHeightInMeters() + ","
				+ getSerialNumber() + "," + getPriceOfTicketInUSD() + ","
				+ getNumberOfChildrenOnAttractionSimultaniously() + "," + getProductionYear();
	}
}
